...
export default function Form() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Box sx={{ width: "70vw", height: "100%", border: "1px solid #98DED9" , p: isSmallScreen ? 3 : 4 , borderRadius:8 , boxShadow: '0px 0px 10px 2px rgba(168, 252, 254,0.7)'}} display="flex" flexDirection="column" alignItems="center" justifyContent="top" marginTop={5}>
